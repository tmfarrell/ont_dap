...
#######
NOTE: On (b), basically will include some event analysis stuff and then some
some relevant downstream alignment data plots, maybe adding in some new 5mer
analysis stuff. Will have to think about how the user will interact with all
this, probably a single bash script should do it; just have to figure out the
details of passing arguments, etc.
#######
