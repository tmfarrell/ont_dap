...
ont_dap is a collection of scripts that (a) facilitate install/ config some tools 
commonly used to analyze data generated by Oxford Nanopore Technologies (ONT) 
